data "aws_iam_policy_document" "mc-aws-backup-service-assume-role-policy-doc" {
  statement {
...
data "aws_iam_policy_document" "mc-pass-role-policy-doc" {
  statement {
    sid       = "MCPassRole"
...
resource "aws_iam_role" "mc-aws-backup-service-role" {
  name               = "MCAWSBackupServiceRole"
  description        = "Allows the AWS Backup Service to take scheduled backups"
  assume_role_policy = data.aws_iam_policy_document.mc-aws-backup-service-assume-role-policy-doc.json
...
resource "aws_iam_role_policy" "mc-backup-service-aws-backup-role-policy" {
  policy = data.aws_iam_policy.aws-backup-service-policy.policy
  role   = aws_iam_role.mc-aws-backup-service-role.name
}

resource "aws_iam_role_policy" "mc-restore-service-aws-backup-role-policy" {
  policy = data.aws_iam_policy.aws-restore-service-policy.policy
  role   = aws_iam_role.mc-aws-backup-service-role.name
}

resource "aws_iam_role_policy" "mc-backup-service-pass-role-policy" {
  policy = data.aws_iam_policy_document.mc-pass-role-policy-doc.json
  role   = aws_iam_role.mc-aws-backup-service-role.name
}